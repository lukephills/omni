...
const _scales: IScale[] = [
  ...
  },
  {
    ...
    description: `Warren Burt's 13 enhharmonic #3, February 19, 1996`
  },
  {
    name: 'Aeolian',
    intervals: [0, 2, 3, 5, 7, 8, 10],
  ...
  },
  {
    name: 'Augmented',
    intervals: [0, 3, 4, 7, 8, 11],
    description: 'Also known in jazz theory as the symmetrical augmented scale. It can be thought of as an interlocking combination of two augmented triads an augmented second or minor third apart: C E G♯ and E♭ G B.'
  },

  {
    name: 'Blues',
    intervals: [0, 3, 5, 6, 7, 10],
    description: 'Since blue notes are alternate inflections, strictly speaking there can be no one blues scale, but the scale most commonly called "the blues scale" comprises a flatted seventh blue note, a flatted third blue note, and a flatted fifth blue note along with other pitches derived from the minor pentatonic scale: C E♭ F F♯ G B♭ C',
  },
  {
    name: 'Dorian',
    intervals: [0, 2, 3, 5, 7, 9, 10],
  ...
  {
    //maybe //TODO: description is shit, not sure a raja exists - perhaps instead choose one of these (maybe Poorvi?) http://www.tanarang.com/english/raagIndex_eng.htm
    name: 'Raja - TODO!',
    frequencies: [
      261.6255653006,
      275.58617649731,
